...
<body>
  <div id="container">
    ...
    <div id="shelf">
	<h2><fmt:message key="publisherEdit.title"/></h2>
	<form:form name="publisherEdit" modelAttribute="publisherEditBean" method="post">
	...
	<tr><th></th><td></td></tr>
		...
		<td class="editValue">
			...
			<c:if test="${publisherEditBean.bookCount eq 0}">
